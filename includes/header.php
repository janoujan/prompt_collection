...
<nav>
  <ul>
    <li><a href="' . BASE_URL . '/index.php" ' . ($script_name === 'index.php' ? 'class="active"' : '') . '><img src="' . BASE_URL . '/assets/images/logo_prompt_collection.png" alt="logo" width="120px" height="120px"></a></li>
